...
public class EovaConfig extends JFinalConfig {
	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(EovaConfig.class);
	...
	public void afterJFinalStart() {
		logger.info("JFinal Started\n");
		// Load Cost Time
		costTime(startTime);
		// logger.debugDsUtil.getDbNameByConfigName(xx.DS_MAIN));
		// logger.debugDsUtil.getPkName(xx.DS_EOVA, "eova_item"));
		// logger.debugDsUtil.getTableNamesByConfigName(xx.DS_EOVA, DsUtil.TABLE));
		// logger.debugDsUtil.getColumnInfoByConfigName(xx.DS_EOVA, "eova_item"));
	}
	...
	public void configConstant(Constants me) {
		...
		logger.info("Config Constants Starting...");
		// 加载配置文件
	...
	public void configRoute(Routes me) {
		logger.info("Config Routes Starting...");
	...
	public void configPlugin(Plugins plugins) {
		logger.info("Config Plugins Starting...");
		...
		// 默认数据源
		{
			...
			logger.debug("load data source:" + url + "/" + user + "/" + pwd);
		}
		// Eova数据源
		{
			...
			plugins.add(dp).add(arp);
			logger.debug("load eova datasource:" + eova_url + "/" + eova_user + "/" + eova_pwd);
		}
	...
	public void configInterceptor(Interceptors me) {
		logger.info("Config Interceptors Starting...");
	...
	public void configHandler(Handlers me) {
		logger.info("Config Handlers Starting...");
		// 添加DruidHandler
